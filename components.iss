...
Name: "API\BepisPlugins";                      Description: "BepisPlugins v16.0.1 (Essential plugins required by many other plugins to function)"  ; Types: full_en full extra extra_en custom bare; Flags: fixed
